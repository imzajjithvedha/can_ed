...
@section('title', 'Proxima Study | School overview FAQ' )
...
@section('content')
    ...
    <form action="{{ route('frontend.user.school_overview_faq_create') }}" method="POST" novalidate>
        {{csrf_field()}}
...
@push('after-scripts')
    <script>
        ...
        $('#ok_button').click(function(){
            $.ajax({
                url:"school-overview-faq/delete/" + faq_id,

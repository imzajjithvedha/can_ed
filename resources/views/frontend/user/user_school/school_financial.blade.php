...
@section('title', 'Proxima Study | School financial' )
                        ...
                        <div class="school" id="nav-financial" role="tabpanel" aria-labelledby="nav-financial-tab">
                            <div class="row">
                                <div class="col-12 border py-3">
                                    ...
                                    <form action="{{ route('frontend.user.school_financial_update') }}" method="POST" onsubmit="return FinancialValForm();" novalidate>
                                        {{csrf_field()}}
                                            <div class="mb-3">

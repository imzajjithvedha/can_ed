                                ...
                                <div class="col-12 border py-3">
                                    ...
                                    <form action="{{ route('frontend.user.school_overview_update') }}" method="POST" enctype="multipart/form-data" onsubmit="return valForm();" novalidate>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="overview_title_3_paragraph" class="form-control" id="overview_title_3_paragraph" value="{{ $school->overview_title_3_paragraph }}" rows="5">{{ $school->overview_title_3_paragraph }}</textarea>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="overview_title_9_paragraph" class="form-control" id="overview_title_9_paragraph" value="{{ $school->overview_title_9_paragraph }}" rows="5">{{ $school->overview_title_9_paragraph }}</textarea>
                                        </div>

...
@section('title', 'Proxima Study | School admission' )
                                    ...
                                    <form action="{{ route('frontend.user.school_admission_update') }}" method="POST">
                                        {{csrf_field()}}
                                            ...
                                            <div class="text-end">
                                                ...
                                                <input type="submit" value="Update admission details" class="btn text-white px-5 py-2" style="background-image: -webkit-linear-gradient(top, #CF0411, #660000); border: none;">
                                            </div>
                                    </form>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="image" class="form-label">Employee image * (Files must be less than 5MB, allowed file types: png, gif, jpg, jpeg)</label>

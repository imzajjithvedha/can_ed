 ...
 */
class UserSchoolFinancialController extends Controller
{
    /**
    ...
    public function schoolFinancial()
    {
        ...
        return view('frontend.user.user_school.school_financial', ['school' => $school]);
    ...
    public function schoolFinancialUpdate(Request $request) {
        ...
        return redirect()->route('frontend.user.school_financial')->with('financial', 'financial');     
    }
}

...
/**
 * Class SchoolsAdmissionEmployeeController.
 */
class SchoolsAdmissionEmployeeController extends Controller
{
    /**
    ...
    public function schoolAdmissionEmployeeCreate(Request $request)
    {
        ...
        return back()->with('created', 'created');
    }


    public function getSchoolAdmissionEmployees($id, Request $request)
    {
        ...
        if($request->ajax())
            {
                return DataTables::of($data)
                    ...
                    ->addColumn('action', function($data){
                        ...
                        $button = '<a href="'.route('admin.schools.school_admission_employee_edit', $data->id).'" name="edit" id="'.$data->id.'" class="edit btn btn-secondary btn-sm me-3" style="font-size: 0.6rem;"><i class="far fa-edit"></i> Edit </a>';
    ...
    public function schoolAdmissionEmployeeEdit($id)
    {
        ...
        return view('backend.schools.admission_employee_edit', ['employee' => $employee]);
    }

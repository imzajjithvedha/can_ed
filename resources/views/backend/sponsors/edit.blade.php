...
@section('title', __('Edit Sponsor | Admin'))

@section('content')
    
    <form action="{{route('admin.sponsors.update_sponsor')}}" method="POST" enctype="multipart/form-data">
        {{csrf_field()}}
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body border">
                        <div class="border p-3">
                            ...
                            <div class="mb-3">
                                <input class="form-control" name="country" value="{{ $sponsor->country }}" placeholder="Country" required>
                            </div>

                            <div class="mb-3">
                                <input class="form-control" name="url" value="{{ $sponsor->url }}" placeholder="URL">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body border">
                        <div class="border p-3">
                            <div class="form-group">
                                <img src="{{ url('images/our_sponsors', $sponsor->image) }}" alt="" class="img-fluid">
                            ...
                            <div class="mt-4 text-center">
                                <input type="hidden" name="hidden_id" value="{{ $sponsor->id }}"/>

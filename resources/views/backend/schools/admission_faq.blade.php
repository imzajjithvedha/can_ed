...
@section('content')
                ...
                <div class="card-body border">
                    <div class="px-3">
                        <div class="row justify-content-between align-items-center mb-2">
                            <div class="col-8 p-0">
                                <h4 class="user-settings-head-faq">Admission FAQ's</h4>
                            </div>
    ...
    <form action="{{ route('admin.schools.school_admission_faq_create') }}" method="POST" novalidate>
        {{csrf_field()}}
    ...
    <script>
        $(function () {
            var table = $('#faq-table').DataTable({
                processing: true,
                ajax: "{{route('admin.schools.get_school_admission_faq', $school->id)}}",
                serverSide: true,
                order: [[2, "asc"]],
                columns: [
        ...
        $(document).on('click', '.delete', function(){
            ...
            url = "{{ route('admin.schools.school_admission_faq_delete', [$school->id, ':faq_id']) }}";

...
@section('title', 'Proxima Study | Edit network')
    ...
    <div class="container user-settings" style="margin-top:8rem;">
        <div class="row justify-content-between">
            ...
            <div class="col-8">
                ...
                <form action="{{ route('frontend.user.user_network_update') }}" method="post" enctype="multipart/form-data" novalidate>
                    {{csrf_field()}}
                    <div class="row">
                        <div class="col-12 border py-3">
                            ...
                            <div>
                                <label class="form-label">Network banner image * (Files must be less than 5MB, allowed file types: png, gif, jpg, jpeg)</label>
                                <div class="row">
                            ...
                            <div class="mt-5 text-center">
                                ...
                                <input type="submit" value="Update network" class="btn text-white px-5 py-2" style="background-image: -webkit-linear-gradient(top, #CF0411, #660000); border: none;">
                            </div>
                        </div>
                    </div>
                </form>

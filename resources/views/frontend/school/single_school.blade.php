    ...
    <div class="container mt-5 single-school">
        ...
        <div class="row">
            <div class="col-12 col-md-3" style="padding-top: 4rem;">
                ...
                <h4 class="fw-bold futura mt-5 p-3" style="background-color: #dbdbdb">Master application</h4>

                <div class="card p-3 master-application" style="background-color: #f0f0f0">

...
@section('title', 'Proxima Study | Create a virtual tour')
    ...
    <div class="container user-settings" style="margin-top:8rem;">
        <div class="row justify-content-between">
            ...
            <div class="col-8">
                <div class="row justify-content-between">
                    <div class="col-8 p-0">
                        <h4 class="user-settings-head">Create a virtual tour</h4>
                    </div>
                </div>

                <div class="row">
                    <div class="col-12 border p-3">
                        <form action="{{ route('frontend.user.store_virtual_tour') }}" method="post" enctype="multipart/form-data" novalidate>
                            {{csrf_field()}}
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <input type="text" class="form-control" id="color" aria-describedby="color" placeholder="Color *" name="color" required>
                                </div>
                                ...
                                <div class="text-center mt-5 mb-3">
                                    <button type="submit" class="btn btn-success px-5" style="background-image: -webkit-linear-gradient(top, #CF0411, #660000); border: none;">Create new</button><br>
                                </div>

...
@section('title', 'Proxima Study | Edit financial FAQ' )
    ...
    <div class="container user-settings" style="margin-top:8rem;">
        <div class="row justify-content-between">
            ...
            <div class="col-8">
                <div class="row justify-content-between">
                    <div class="col-8 p-0">
                        <h4 class="user-settings-head">Edit financial FAQ</h4>
                ...
                <div class="row">
                    <div class="col-12 border py-3">
                        <form action="{{ route('frontend.user.school_financial_faq_update') }}" method="post" enctype="multipart/form-data" novalidate>
                            {{csrf_field()}}
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="answer" id="answer" rows="5" class="form-control" aria-describedby="answer" placeholder="Answer" name="answer" value="{{ $faq->answer }}" required>{{ $faq->answer }}</textarea>
                            </div>

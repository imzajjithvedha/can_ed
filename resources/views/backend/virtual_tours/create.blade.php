...
@section('content')
    ...
    <form action="{{ route('admin.virtual_tours.store_virtual_tour') }}" method="post" enctype="multipart/form-data" novalidate>
        {{csrf_field()}}
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body border">
                        <div class="border p-3">
                            ...
                            <div class="mb-3">
                                <input type="url" class="form-control" id="url" aria-describedby="url" placeholder="Virtual tour URL *" name="url" required> 
                            </div>
                            ...
                            <div class="form-group">
                                <select class="form-control" id="featured" name="featured" placeholder="Featured? *" required>
                                    <option value="" selected disabled hidden>Do you want to show this virtual tour in the homepage? *</option>

                ...
                <div class="row align-items-center">
                    <div class="col-12">
                        ...
                        {{ csrf_field() }}
                            ...
                            <!-- <div class="mb-3">
                                <input type="date" class="form-control" id="dob" aria-describedby="dob" placeholder="Date of birth" name="dob" required>
                            </div>
                            <div class="mb-3">
                                <input type="text" class="form-control" id="education" aria-describedby="education" placeholder="Highest level of education" name="education" required>
                            </div>
                            <div class="mb-3">
                                <select class="form-control" id="timezone" name="gender" placeholder="Select gender" required>
                            ...
                            <div class="mb-3">
                                <select class="form-control" id="country" name="country" placeholder="Country of birth" required>
                            ...
                            <div class="mb-3">
                                <select class="form-control" id="country" name="country" placeholder="Country of residence" required>
                            ...
                            <div class="mb-3">
                                <input type="text" class="form-control" id="phone_number" aria-describedby="phone_number" placeholder="Enter your phone number" required>
                            </div> -->

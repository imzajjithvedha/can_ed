...
@section('content')
    ...
    <form action="{{route('admin.sponsors.update_sponsor')}}" method="POST" enctype="multipart/form-data" novalidate>
        {{csrf_field()}}
        <div class="row">
                    ...
                    <div class="card-body border">
                        <div class="border p-3">
                            <div class="form-group">
                                <img src="{{ url('images/our_sponsors', $sponsor->image) }}" alt="" class="img-fluid w-100" style="height: 13rem; object-fit:cover;">
...
@push('after-scripts')
    <script>
        $(document).ready(function() {
            let value = <?php echo json_encode ($sponsor->country) ?>

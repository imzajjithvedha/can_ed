<div class="fixed-top menu-nav">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bottom-nav py-3">
        <div class="container position-relative">
          ...
          <a href="{{ route('frontend.index') }}"><img src="{{ url('img/frontend/logo_new.png') }}" alt="" class="img-fluid position-absolute" style="height: 5rem; top: -2rem"></a>

          <!-- <a href="{{ route('frontend.index') }}"><img src="{{ url('img/frontend/logo_new_1.png') }}" alt="" class="img-fluid position-absolute" style="height: 5rem; top: -1.7rem"></a> -->

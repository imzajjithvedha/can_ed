...
/**
 * Class SchoolsQuickFactsController.
 */
class SchoolsQuickFactsController extends Controller
{
    /**
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\View\View
     */
    
    public function schoolQuickFacts($id)
    {
        ...
        return view('backend.schools.quick_facts', ['school' => $school, 'school_types' => $school_types, 'marked_facts' => $marked_facts]);
    ...
    public function schoolQuickFactsUpdate(Request $request) {
        ...
        $school = DB::table('schools') ->where('id', request('hidden_id'))->update(
            [
                ...
                'number_of_programs' => $request->number_of_programs,
                'number_of_graduate_programs' => $request->number_of_graduate_programs,
                'number_of_undergraduate_programs' => $request->number_of_undergraduate_programs,
                'number_of_students' => $request->number_of_students,
                'number_of_graduate_students' => $request->number_of_graduate_students,
                'number_of_undergraduate_students' => $request->number_of_undergraduate_students,

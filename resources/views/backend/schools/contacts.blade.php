...
@section('content')
            ...
            <div class="card">
                <div class="card-body border">
                    <div class="border p-3">
                        <form action="{{ route('admin.schools.school_contacts_paragraph_update') }}" method="POST" novalidate>
                            {{csrf_field()}}
                            <div class="mb-3">
    ...
    <form action="{{ route('admin.schools.school_contact_create') }}" method="POST" novalidate>
        {{csrf_field()}}

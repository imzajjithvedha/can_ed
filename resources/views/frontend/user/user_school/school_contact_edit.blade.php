    ...
    <div class="container user-settings" style="margin-top:8rem;">
        <div class="row justify-content-between">
            ...
            <div class="col-8">
                <div class="row justify-content-between">
                    <div class="col-8 p-0">
                        <h4 class="user-settings-head">Edit contact</h4>
                ...
                <div class="row">
                    <div class="col-12 border py-3">
                        <form action="{{ route('frontend.user.school_contact_update') }}" method="post" enctype="multipart/form-data" novalidate>
                            {{csrf_field()}}
                            ...
                            <div class="mt-5 text-center">
                                ...
                                <input type="submit" value="Update contact" class="btn rounded-pill text-light px-5 py-2" style="background-color: #94ca60;">
                            </div>
...
@push('after-scripts')
    ...
    <script>
        $(document).ready(function() {
            let value = <?php echo json_encode ($contact->country) ?>

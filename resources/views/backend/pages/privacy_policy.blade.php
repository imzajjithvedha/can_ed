...
@section('content')
    ...
    <form action="{{ route('admin.pages.privacy_policy_update') }}" method="post" enctype="multipart/form-data" novalidate>
        {{csrf_field()}}
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body border">
                        <div class="border p-3">
                            ...
                            @if($privacy->image != null)
                                <img src="{{ url('images/pages', $privacy->image) }}" alt="" class="img-fluid w-100" style="height: 10rem; object-fit: cover;">
                            @else

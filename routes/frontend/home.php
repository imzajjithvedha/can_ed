...
Route::get('scholarships-advanced-search-results/{name}/{school}/{province}/{award}/{action}/{min_amount}/{max_amount}/{availability}/{level_of_study}/{duration}',[ScholarshipController::class,'advancedSearchFunction'])->name('scholarship_advanced_search_function');

...
@section('title', 'Proxima Study | Edit scholarship FAQ' )
    ...
    <div class="container user-settings" style="margin-top:8rem;">
        <div class="row justify-content-between">
            ...
            <div class="col-8">
                <div class="row justify-content-between">
                    <div class="col-8 p-0">
                        <h4 class="user-settings-head">Edit scholarship FAQ</h4>
                ...
                <div class="row">
                    <div class="col-12 border py-3">
                        ...
                        <form action="{{ route('frontend.user.school_scholarship_faq_update') }}" method="post" enctype="multipart/form-data" novalidate>
                            {{csrf_field()}}

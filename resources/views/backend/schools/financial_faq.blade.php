...
@section('content')
                ...
                <div class="card-body border">
                    <div class="px-3">
                        <div class="row justify-content-between align-items-center mb-3">
                            <div class="col-8 p-0">
                                <h4 class="user-settings-head-faq">Financial FAQ's</h4>
                            </div>
    ...
    <form action="{{ route('admin.schools.school_financial_faq_create') }}" method="POST" novalidate>
        {{csrf_field()}}
...
@push('after-scripts')
    ...
    <script>
        ...
        $(document).on('click', '.delete', function(){
            ...
            url = "{{ route('admin.schools.school_financial_faq_delete', [$school->id, ':faq_id']) }}";
